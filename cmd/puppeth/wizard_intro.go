...
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your PFCoin private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new PFCoin network down to  |")
	...
	log.Info("Administering PFCoin network", "name", w.network)
