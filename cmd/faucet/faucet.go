...
// faucet is a Pfc faucet backed by a light client.
package main
...
var (
	...
	ethPortFlag = flag.Int("ethport", 30333, "Listener port for the devp2p connection")
	bootFlag    = flag.String("bootnodes", "", "Comma separated bootnode enode URLs to seed with")
	netFlag     = flag.Uint64("network", 0, "Network ID to use for the PFCoin protocol")
	...
	logFlag    = flag.Int("loglevel", 3, "Log level to use for PFCoin and the faucet")
)
...
// apiHandler handles requests for Pfc grants and transaction statuses.
...
func authGitHub(url string) (string, string, common.Address, error) {
	...
	if address == (common.Address{}) {
		return "", "", common.Address{}, errors.New("No PFCoin address found to fund")
	}
